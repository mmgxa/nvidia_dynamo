# 02 - DisAggregated Serving

Here, we will deploy NVIDIA Dynamo with disaggregated serving on
a local Minikube cluster. This assumes you have completed all the steps in the [README.md](./README.md) file. This will also require > 1 GPUs since we will place the two stages on separate GPUs.
